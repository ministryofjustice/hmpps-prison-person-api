...
-- Food allergies
('FOOD_ALLERGY_CELERY', 'FOOD_ALLERGY', 'CELERY', 'Celery', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_GLUTEN', 'FOOD_ALLERGY', 'GLUTEN', 'Cereals containing gluten', 0, '2024-07-21 14:00:00+0100',
 'CONNECT_DPS'),
('FOOD_ALLERGY_CRUSTACEANS', 'FOOD_ALLERGY', 'CRUSTACEANS', 'Crustaceans', 0, '2024-07-21 14:00:00+0100',
 'CONNECT_DPS'),
('FOOD_ALLERGY_EGG', 'FOOD_ALLERGY', 'EGG', 'Egg', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_FISH', 'FOOD_ALLERGY', 'FISH', 'Fish', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_LUPIN', 'FOOD_ALLERGY', 'LUPIN', 'Lupin', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_MILK', 'FOOD_ALLERGY', 'MILK', 'Milk', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_MOLLUSCS', 'FOOD_ALLERGY', 'MOLLUSCS', 'Molluscs', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_MUSTARD', 'FOOD_ALLERGY', 'MUSTARD', 'Mustard', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_PEANUTS', 'FOOD_ALLERGY', 'PEANUTS', 'Peanuts', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_SESAME', 'FOOD_ALLERGY', 'SESAME', 'Sesame', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_SOYA', 'FOOD_ALLERGY', 'SOYA', 'Soya', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_SULPHUR_DIOXIDE', 'FOOD_ALLERGY', 'SULPHUR_DIOXIDE', 'Sulphur Dioxide', 0, '2024-07-21 14:00:00+0100',
 'CONNECT_DPS'),
('FOOD_ALLERGY_TREE_NUTS', 'FOOD_ALLERGY', 'TREE_NUTS', 'Tree nuts', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('FOOD_ALLERGY_OTHER', 'FOOD_ALLERGY', 'OTHER', 'Other', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
-- Medical dietary requirements
('MEDICAL_DIET_FREE_FROM', 'MEDICAL_DIET', 'FREE_FROM', 'Other', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('MEDICAL_DIET_LOW_FAT', 'MEDICAL_DIET', 'LOW_FAT', 'Low fat', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('MEDICAL_DIET_LOW_SALT', 'MEDICAL_DIET', 'LOW_SALT', 'Low salt', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('MEDICAL_DIET_DIABETIC', 'MEDICAL_DIET', 'DIABETIC', 'Diabetic', 0, '2024-07-21 14:00:00+0100', 'CONNECT_DPS'),
('MEDICAL_DIET_LOW_CHOLESTEROL', 'MEDICAL_DIET', 'LOW_CHOLESTEROL', 'Low cholesterol', 0, '2024-07-21 14:00:00+0100',
 'CONNECT_DPS'),
